...
cool_reviewer_2 = Reviewer('Alex', 'Smith')
cool_reviewer_2.courses_attached += ['Python']
cool_reviewer_2.courses_attached += ['Java']

student_1 = Student('Den', 'Zverev')
student_1.courses_in_progress += ['Python']
student_1.finished_courses += ['Введение в программирование']

student_2 = Student('Tom', 'Romanov')
...
print('Результат сравнения студентов (по средним оценкам за ДЗ):')
...
print('Результат сравнения лекторов (по средним оценкам за лекции):')
if best_lecturer_1 > best_lecturer_2:
  print(f'{best_lecturer_1.surname} преподает лучше чем {best_lecturer_2.surname}')
else:
  print(f'{best_lecturer_2.surname} преподает лучше чем {best_lecturer_1.surname}')
print()
print()
